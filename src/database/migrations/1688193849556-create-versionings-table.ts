...
export class CreateVersioningsTable1688193849556 implements MigrationInterface {
    name = 'CreateVersioningsTable1688193849556'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "versionings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" character varying NOT NULL, "file_key" character varying NOT NULL, "description" text, "application_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_885e383b48f0e4190523d6d1df5" PRIMARY KEY ("id"))`);
